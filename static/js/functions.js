                        ...
                        success: function (data) {
                          if (data.valid) {
                              if (data.register){
                                  ...
                                  document.getElementById("form3-username").value = username.value;
                                  document.getElementById("form4-username").value = username.value;
                              }
                              else{
                                 window.location.assign('{{callback}}');
                              }
                          }else{
                            document.getElementById('error-rcode').hidden = false;
                          }
